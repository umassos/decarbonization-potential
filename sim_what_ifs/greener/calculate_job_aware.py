...
main_save_to_dir = 'data_output/processed_weighted_interrupt'
    ...
    for row, slack in enumerate(slack_list): 
        ...
        for member in members:
            ...
            for w, job in enumerate(job_length_list): 
                ...
                abs_combined_file = f"{main_data_dir}/job_{job}/slack_{slack}/{member}_combined.csv" # savings -- the difference already accounted
