...
period_file =  '../trace_analysis/periodicity/periodicity_score.csv'
...
suplabelsize = 16
fig.supylabel(r"Global CO$_2$ Savings (%)", y=0.40,  x=-0.08,fontsize=suplabelsize)
...
for slack_index, slack in enumerate(slacklist): 
    ...
    # ax[slack_index].spines[['top','right']].set_visible(False)
# plt.grid(alpha=0.5)
fig.subplots_adjust(left=0, right=1, bottom=0, top=0.8)
fig.subplots_adjust(wspace=0, hspace=0.0)
# savename = f"{savetodir}/stacked_subplots_with_flags2"
